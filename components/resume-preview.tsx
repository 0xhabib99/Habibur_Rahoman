import { Mail, Phone, Linkedin, Award, PenToolIcon as Tool, Globe, Book, Code, User, FileText } from "lucide-react"
import ScanEffect from "./scan-effect"

export default function ResumePreview() {
  return (
    <div className="bg-gray-900 dark:bg-gray-900 rounded-lg overflow-hidden relative">
      <ScanEffect />

      <div className="bg-gray-800 dark:bg-gray-800 px-4 py-2 flex items-center relative z-20">
        <User className="w-5 h-5 mr-2 text-blue-400 dark:text-green-400" />
        <div className="text-gray-200 text-sm flex-1">Resume</div>
        <a
          href="/resume-viewer"
          target="_blank"
          className="flex items-center text-xs text-blue-400 dark:text-green-400 hover:text-blue-300 dark:hover:text-green-300 transition-colors"
          rel="noreferrer"
        >
          <FileText className="w-4 h-4 mr-1" /> View Full PDF
        </a>
      </div>

      <div className="p-6 relative z-20 bg-white dark:bg-black text-gray-900 dark:text-gray-100">
        {/* Header */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            ...
            <div>
              <h3 className="text-lg font-bold text-blue-600 dark:text-green-500 mb-2 flex items-center">
                <Tool className="w-4 h-4 mr-2" /> TOOLS
              </h3>
          ...
          <div className="md:col-span-2 space-y-6">
            ...
            <div>
              ...
              <div className="text-sm">
                ...
                <p>
                CEO, QA Pro Ltd. | APAC Head - CyberProof, Australia | Help Organizations to Protect Their Digital Assets | Chair, OWASP Dhaka Chapter | ISACA Dhaka Chapter Board Member | Instructor, MIST | Trainer | Writer
                </p>
